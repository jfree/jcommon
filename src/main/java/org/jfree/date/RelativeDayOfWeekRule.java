...
import static org.jfree.date.SpreadsheetDate.MAXIMUM_YEAR_SUPPORTED;
import static org.jfree.date.SpreadsheetDate.MINIMUM_YEAR_SUPPORTED;
import static org.jfree.date.WeekdayRange.LAST;
import static org.jfree.date.WeekdayRange.NEAREST;
import static org.jfree.date.WeekdayRange.NEXT;
...
public class RelativeDayOfWeekRule extends AnnualDateRule {
    ...
    public RelativeDayOfWeekRule() {
        this(new DayAndMonthRule(), MONDAY, NEXT);
    }
